...
import PICard from "../componenets/Cards/PICard";
import MemberCard from "../componenets/Cards/MemberCard";
        ...
        <div className="hero bg-base-200 min-h-screen">
          <div className="hero-content text-center">
            <div className="max-w-4xl">
              <h1 className="text-5xl font-bold text-base-content">About Us</h1>
