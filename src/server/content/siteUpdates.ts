    ...
    biographies: [
      {
        ...
        "paragraphs": [
          "Dr. Zhe Zhang, the organizer of CaGIS’ CyberTraining workshop, is an Associate Professor in the Department of Geography at Texas A&M University, with joint appointments in the Department of Electrical and Computer Engineering and the Texas A&M Hazard Reduction and Recovery Center. Her research develops spatial decision support systems that integrate advanced cyberinfrastructure, GeoAI, and participatory design to address disaster management and sustainability challenges, and has been funded by NSF, NASA, USDOT, NOAA, and the National Geographic Society. She has chaired the AAG Cyberinfrastructure Specialty Group, serves on the CaGIS Board of Directors, and chairs the UCGIS Research Committee. She is Co-PI of the NSF-funded FASTER supercomputer and Co-Investigator of the ACES supercomputer at Texas A&M, serves as Associate Editor for Computational Urban Science, and has received the Texas A&M Pathways Award and the NSF CAREER Award."
        ]
      },
      {
        "name": "Honggao Liu",
